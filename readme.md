...
这里有一系列好用的翻墙规则，针对 [Shadowrocket](https://liguangming.com/Shadowrocket) 开发，支持广告过滤。规则定义了哪些网站可以直连，哪些必须走代理，规则是一个纯文本文件，无法提供翻墙功能。使用开源的力量，集众人之力逐渐完善。
...
![规则选择指南](https://windowsmemz.github.io/Shadowrocket-ADBlock-Rules-New/figure/guide.png)
...
[**壁虎云**](https://geckoiplc.org/register?aff=iUnSEC)
